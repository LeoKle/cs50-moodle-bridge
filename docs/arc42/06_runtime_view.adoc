...
3. The request is forwarded to the Course Service.
...
1. A tutor uploads an export from Moodle which states the students that are enrolled in the respective course.
2. The Enrollment Controller validates the request.
3. The Enrollment Service creates enrollment records.
